...
class Go_Wild_Publisher : public rclcpp::Node {
 public:
  Go_Wild_Publisher() : Node("go_wild_publisher") {
    ...
    subscription_ = this->create_subscription<action_msgs::msg::GoalStatus>("/eve/whole_body_trajectory_status", 10,
                                                                            std::bind(&Go_Wild_Publisher::status_callback, this, _1));
 ...
 private:
  ...
  WholeBodyTrajectoryPoint target1_(int32_t t) {
    ...
    ret_msg.task_space_commands.push_back(
        generate_task_space_command(ReferenceFrameName::PELVIS, ReferenceFrameName::BASE, true, 0.0, 0.0, SQUAT_HEIGHT_));
  ...
  WholeBodyTrajectoryPoint target4_(int32_t t) {
    ...
    ret_msg.task_space_commands.push_back(
        generate_task_space_command(ReferenceFrameName::PELVIS, ReferenceFrameName::BASE, true, 0.0, 0.0, DEFAULT_HEIGHT_));
  ...
  WholeBodyTrajectoryPoint target5_(int32_t t) {
    ...
    ret_msg.task_space_commands.push_back(generate_task_space_command(ReferenceFrameName::PELVIS, ReferenceFrameName::BASE, true, 0.0, 0.0,
                                                                      SQUAT_HEIGHT_, 0.0, 0.0, M_PI / 2));
