...
class YawAndPivotPublisher : public rclcpp::Node {
 public:
  YawAndPivotPublisher() : Node("yaw_pivot_trajectory_publisher") {
    ...
    subscription_ = this->create_subscription<action_msgs::msg::GoalStatus>("/eve/whole_body_trajectory_status", 10,
                                                                            std::bind(&YawAndPivotPublisher::status_callback, this, _1));
  ...
  */
  WholeBodyTrajectoryPoint target1_(int32_t t) {
    ...
    ret_msg.task_space_commands.push_back(generate_task_space_command(halodi_msgs::msg::ReferenceFrameName::PELVIS,
                                                                      halodi_msgs::msg::ReferenceFrameName::BASE, true, 0.0, 0.0, 0.7));
  ...
  WholeBodyTrajectoryPoint target3_(int32_t t) {
    ...
    ret_msg.task_space_commands.push_back(generate_task_space_command(
        halodi_msgs::msg::ReferenceFrameName::PELVIS, halodi_msgs::msg::ReferenceFrameName::BASE, true, 0.0, 0.0, 0.91, 0.0, 0.0, 1.0));
