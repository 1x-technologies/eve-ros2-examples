...
namespace eve_ros2_examples {
  ...
  */
  halodi_msgs::msg::JointSpaceCommand generate_joint_space_command(int32_t joint_id, double q_des, double qd_des = 0.0, double qdd_des = 0.0)
  {
  ...
  */
  halodi_msgs::msg::TaskSpaceCommand generate_task_space_command(int32_t body_frame_id, int32_t expressed_in_frame_id, bool use_z_up, double px_des, double py_des, double pz_des, double roll_des = 0.0, double pitch_des = 0.0, double yaw_des = 0.0)
  {
